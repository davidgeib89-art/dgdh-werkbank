export const queryKeys = {
  ...
  agents: {
    ...
    roleTemplates: ["agents", "role-templates"] as const,
  },
  issues: {
  ...
  memory: {
    all: ["memory"] as const,
    viewer: (companyId: string) => ["memory", companyId, "viewer"] as const,
    viewerList: (
      companyId: string,
      scope?: string[],
      kind?: string[],
      ...
      [
        ...
        "viewer",
        "list",
        { scope, kind, agentId, projectId, text, page },
      ] as const,
    viewerStats: (companyId: string) =>
      ["memory", companyId, "viewer", "stats"] as const,
    reflectionReport: (companyId: string, agentId: string) =>
      ["memory", companyId, "reflection", agentId] as const,
    retrievalTrace: (
      companyId: string,
      agentId: string,
      projectId?: string,
