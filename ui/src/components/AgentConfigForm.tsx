            ...
            {allowCustomModel && (
              <div className="mt-1 border-t border-border pt-2 px-1">
                ...
                <div className="flex items-center gap-1">
                  <input
                    className="h-8 w-full rounded border border-border bg-transparent px-2 text-xs outline-none placeholder:text-muted-foreground/50"
                  ...
                  <button
                    type="button"
                    className="h-8 shrink-0 rounded border border-border px-2 text-xs hover:bg-accent/50"
                    onClick={() => {
                      const trimmed = customModel.trim();
                      if (!trimmed) return;
                      onChange(trimmed);
