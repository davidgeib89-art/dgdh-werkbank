...
Current phase: `first-live-mission-cell-proof-v1`

## Objective

Carry DGDH from "the mission-cell lane exists" to "one mission cell has been used once for real,
hardened once from real friction, and promoted into durable firm truth."
...
- do not report before `launch -> live proof -> proof-discovered hardening -> promotion`
...
- launch `missionCell: first-live-mission-cell-proof-v1` on a real bounded internal target
- carry one real live-proof cut on long-autonomy continuity and mission-state truth
- harden the first real friction discovered during that live proof
- promote the result into durable mission, memory, and recovery truth
- isolate what remains firm-bound versus carrier-bound after the first live run
...
- `strong success`: one real mission cell has been used on a bounded self-improvement target,
  at least one proof-discovered hardening cut landed, and the result was promoted into durable truth
- `truthful partial`: launch plus multiple real phases landed, but the remaining blocker is real,
...
10. `company-hq/mission-contracts/first-live-mission-cell-proof-v1.md`
11. `company-hq/mission-cells/first-live-mission-cell-proof-v1.json`
...
Use the lane once for real, harden what it reveals, and promote the truth.
