...
- Recovery grace is configurable via `HEARTBEAT_RECOVERY_GRACE_MS` (periodic sweep, default: 2 minutes) and `HEARTBEAT_STARTUP_RECOVERY_GRACE_MS` (startup sweep, default: 3 minutes, never less than periodic).
